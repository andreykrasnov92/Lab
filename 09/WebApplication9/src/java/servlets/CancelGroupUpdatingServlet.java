...
@WebServlet(name = "CancelGroupUpdatingServlet", urlPatterns = {"/cancelgroupupdating.jsp"})
public class CancelGroupUpdatingServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            bean.cancelGroupUpdating(groupId);
