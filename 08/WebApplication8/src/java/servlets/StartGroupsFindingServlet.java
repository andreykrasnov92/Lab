...
@WebServlet(name = "StartGroupsFindingServlet", urlPatterns = {"/findgroups.jsp"})
public class StartGroupsFindingServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("/startgroupsfinding.jsp");
            if (dispatcher != null) {
