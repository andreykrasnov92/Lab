...
@WebServlet(name = "DeleteGroupServlet", urlPatterns = {"/submitgroupdeleting.jsp"})
public class DeleteGroupServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("/deletegroupresult.jsp");
            if (dispatcher != null) {
                dispatcher.forward(request, response);
            }
        } catch (IllegalOrphanException | NonexistentEntityException | SQLException ex) {
            printException(ex);
