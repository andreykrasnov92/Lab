...
@WebServlet(name = "DeleteStudentServlet", urlPatterns = {"/submitstudentdeleting.jsp"})
public class DeleteStudentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            bean.deleteStudent(studentId);
            RequestDispatcher dispatcher = request.getRequestDispatcher("/deletestudentresult.jsp");
            if (dispatcher != null) {
                dispatcher.forward(request, response);
            }
        } catch (NonexistentEntityException | SQLException ex) {
            printException(ex);
