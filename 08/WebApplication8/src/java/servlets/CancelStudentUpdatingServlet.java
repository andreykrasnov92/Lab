...
@WebServlet(name = "CancelStudentUpdatingServlet", urlPatterns = {"/cancelstudentupdating.jsp"})
public class CancelStudentUpdatingServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            bean.cancelStudentUpdating(studentId);
