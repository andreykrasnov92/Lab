...
/**
 * Jersey REST client generated for REST resource:GruppaFacadeREST
 * [entities.gruppa]<br>
 * USAGE:
 * <pre>
 ...
 * </pre>
 */
public class GruppaJerseyClient {

    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = "http://localhost:8079/WebApplication12/webresources";

    public GruppaJerseyClient() {
        client = ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("entities.gruppa");
    }
