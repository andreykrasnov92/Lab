...
@WebServlet(name = "StartGroupUpdatingServlet", urlPatterns = {"/updategroup.jsp"})
public class StartGroupUpdatingServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("/startgroupupdating.jsp");
            if (dispatcher != null) {
