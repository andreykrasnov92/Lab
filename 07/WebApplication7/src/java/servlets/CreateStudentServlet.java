...
public class CreateStudentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            controller.createStudent(studentId, studentName, groupId);
            RequestDispatcher dispatcher = request.getRequestDispatcher("/createstudentresult.jsp");
            if (dispatcher != null) {
                dispatcher.forward(request, response);
            }
        } catch (EmptyStringException | NonexistentEntityException |
                PreexistingEntityException | SQLException | StringFormatException ex) {
            printException(ex);
