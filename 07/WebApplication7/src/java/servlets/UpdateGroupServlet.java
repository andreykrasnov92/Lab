...
@WebServlet(name = "UpdateGroupServlet", urlPatterns = {"/submitgroupupdating.jsp"})
public class UpdateGroupServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            controller.updateGroup(groupId, groupName);
            RequestDispatcher dispatcher = request.getRequestDispatcher("/updategroupresult.jsp");
            if (dispatcher != null) {
